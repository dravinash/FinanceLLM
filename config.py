class parameters():
    ...
    root_path = "D:/Codes/FinQA/"
    output_path = "D:/Codes/FinQA/models/"
    cache_dir = "D:/Codes/FinQA/cache/"
    ...
    train_file = root_path + "dataset/train.json" # "dataset/train_retrieve.json"
    valid_file = root_path + "dataset/dev.json" # "dataset/dev_retrieve.json"
    test_file = root_path + "dataset/test.json" # "dataset/test_retrieve.json"
